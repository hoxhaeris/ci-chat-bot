...
func Handle(client *slack.Client, manager manager.JobManager, botCommands []parser.BotCommand, aiClient AIClient, recorders ...chatmetrics.CommandRecorder) events.PartialHandler {
