...
func (c *commandActivitySlackClient) UpdateMessage(string, string, ...slack.MsgOption) (string, string, string, error) {
	return "", "", "", fmt.Errorf("unexpected UpdateMessage call")
}
